...
for ind_method = 1 : numel(methods)
    for ind_bench = 1 : numel(bench_names)
        ...
        base_name = ['before_ba_' bench_name '_' method_name '_' curr_date];
        ...
        for j = 1 : trials_num
            ...
            for i = 1 : numel(algo_names)
                   ...
                   [~, f_diffs, R_diffs, t_diffs] = make_bench_abs(algo_names{i}, [input_path_base '/' algo_names{i} '/' num2str(j)], input_path_gt, output_file_name, true);
